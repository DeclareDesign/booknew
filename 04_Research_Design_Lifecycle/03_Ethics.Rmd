...
- define the ethical judgement of a realized experiment as a set of diagnostic statistics
- define baseline cut-off values -- minimum thresholds of these diagnostic statistics to be ethical
- among ethical designs, use diagnosis to tradeoff these ethical features with features of the research design
- communicate your ethical judgement of the design through diagnosands -- appropriate summaries of worst case scenarios and average values of ethical diagnostic statistics -- not based just on ex post what happened. structured ex ante guesses.
- at bottom, there are a set of designs that are not ethical, and among those that are there are still ethical tradeoffs and we should be more systematic
- what this implies is that we are assigning a value to ethical outcomes and also to the output of the research in terms of knowledge gained
