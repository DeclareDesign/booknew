...
After publication, research studies leave the hands of researchers and enter the public domain. However, researchers can prepare for the integration of their studies into scholarly debates through better archiving practices, as well as better reporting of research designs in the published article. 

Later researchers may build on the results of a past study in three ways: reanalyze the original data, holding $d$ constant but changing $A$ (reanalysis); providing a new answer to the same $I$ with new data, possibly changing $D$ and $A$ (replication); or synthesizing the study's answer $a^d$ to the inquiry along with other past studies (meta-analysis). In this section, we outline archiving procedures to enable later researchers to reanalyze, replicate, or synthesize; and we describe procedures for doing each of these three integration tasks.
