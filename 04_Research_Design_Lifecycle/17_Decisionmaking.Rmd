...
designs <- redesign(design, N = seq(from = 100, to = 3000, by = 500), effect_size = seq(from = 0, to = 0.25, by = 0.05))
...
gg1 <- diagnosis %>% 
  ...
  scale_color_discrete("True effect size", type = c('#b2182b','#ef8a62','#f7f7f7','#d1e5f0','#67a9cf','#2166ac'),
                       labels = c("0 (retain status quo)", "0.05", "0.1 (indifferent)", "0.15", "0.2", "0.25 (switch to treatment)")) + 
