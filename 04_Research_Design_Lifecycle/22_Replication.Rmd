...
A summary function is needed to interpret the difference between the original answer and the replication answer. This might take the new one and throw out the old if MIDA was poor in the first. It might be taking the average. It might be a precision-weighted average. Specifying this function ex-ante may be useful to avoid the choice of summary depending on the replication results. This summary function will be reflected in *A* and in the discussion section of the replication paper. 
