...
Funders who request design declarations can compare funding applications on common scales: root mean-squared-error, bias, and power. Of course, they also want to weigh considerations like the importance of the question and the fit with their funding program. Moving design considerations onto a common scale takes guesswork out of the process and reduces reliance on researcher claims about properties.
