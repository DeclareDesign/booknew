...
MIDA is a tool for communicating the quality of a design to reviewers and, later, readers
...
Idea: redesign after review, so you have a design that reflects the original design modified by reviewer requests and use diagnosis to demonstrate its (still) high quality to readers who may be skeptical of changes made during the review process that were not originally planned.
