...
Of course, exact replication is impossible: at least some elements of M have changed between the first study and the replication. Specifying how they might have changed, e.g., how outcomes vary with time, will help judge differences observed between $a_{old}^D$ and $a_{new}^D$. Statistical noise will also play a role.
...
- @Clemens2015 on distinctions between replication and reanalysis
