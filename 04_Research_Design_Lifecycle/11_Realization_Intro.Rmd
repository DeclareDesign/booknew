...
In fact, the declared design can guide each step of realizing a study, from implementing the data and answer strategy, writing up a "populated" PAP, reconciling the planned and implemented study, writing it up, and publishing it.
