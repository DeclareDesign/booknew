...
* a causal *model* of the world, which defines a set of units we want to learn about, a set of variables that represent characteristics of the units, and how those variables interact. The model represents your theory of the world.

* a research *inquiry*, which is a function of variables defined in the model. This is a question defined in the theoretical terms described by the model.
...
## Declaring and diagnosing designs in code
...
We wrote the companion software to the book, `DeclareDesign`, in the R statistical environment because of the availability of other tools for implementing research designs and because it is free-to-use.

A declared design can be as simple as:
