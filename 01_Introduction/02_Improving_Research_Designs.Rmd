...
We collect our principles of research design together here:
...
P9. Data strategies should rule out threats to validity with sampling, assignment, and measurement procedures.  
  
P8. Answer strategies should explicitly target inquiries.   
  
P9. When data strategies introduce no distortions, answer strategies can be directly analogous to inquiries. When data strategies do introduce distortions, they must be compensated for in the answer strategy.   
