...
The redesign process is about optimizing you research design given constraints. Usually, the most important constraints are ethical, logistical, and financial. If related diagnosands (total harm to subjects, total researcher hours, total project cost) exceed acceptable levels, the design is not feasible -- we want to choose the best design we can given those fundamental limitations. 
...
you can then assess whether your inquiry, data strategy, and answer strategy can distinguish the case where you are right and the case where you are wrong. and you can assess whether you design will perform well both in favorable and unfavorable conditions. 
...
**Data strategies should rule out threats to validity with sampling, assignment, and measurement procedures.**
