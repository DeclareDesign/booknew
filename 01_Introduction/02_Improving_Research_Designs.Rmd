...
To illustrate declaring a design in code, we declare a simplified version of the @Gulzar2020 study. In Appendix XX we declare the complete design.
...
In this section, we declare the @Gulzar2020 example in finer detail. The aim is to capture all of the analytically-relevant features of the design. 
