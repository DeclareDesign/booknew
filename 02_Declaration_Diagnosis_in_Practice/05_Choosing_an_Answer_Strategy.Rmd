...
This declaration asserts a choice about the model (linear regression using the built-in `lm` function), the functional form (linear terms for the treatment variable and a covariate), selects the coefficient of interest that forms our estimate (`Z`), and links that estimate to an estimate ("ATE"). 
