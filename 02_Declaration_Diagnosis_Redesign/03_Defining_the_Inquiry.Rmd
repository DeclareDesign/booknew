...
draw_estimands(M+I) %>% 
  kable(caption = "One model three estimands.", digits = 2, booktabs = TRUE)
...
Curiously however there may be no units form whom $x_i = 0$ and so we cannot easily think of the estimand as being a summary of individual potential outcomes. 
...
Another way is to imagine a more complex summary where we construct a continuous CEF for the case with $Z=1$ and $Z=0$ and evaluate the difference between these when $X=0$. Though complex this is itself a summary of the potential outcomes though the nature of the estimand (not the estimate) depends on how the CEF is constructed.
