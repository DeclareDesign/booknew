...
An inquiry is defined by four items: a summary function, and its three arguments, the units, treatment conditions, and outcomes.^[A common framework for defining research questions it the UTOS (units, treatments, outcomes, and settings) conceptualization of @cook2002experimental. We omit the setting, also known as context, and instead consider the possibility of manipulating the setting in which a treatment is administered to units as an additional component of the treatment.] The units are the set of units within the model that the inquiry refers to, either all or a subset. The treatment conditions represents the set chosen for study. A descriptive inquiry is a summary of a single condition (reality), whereas a causal inquiry is a summary of multiple conditions. The last element is the outcomes, which is the set of nodes in the model that the inquiry concerns. The inquiry might focus on a single outcome or a summary of more than one as in an index.
<!-- rewrite the section around UTO! rather than "three kinds..." -->
...
- ATE vs ATT vs ATC; PATE vs SATE; ATE vs LATE; etc.

### Treatment conditions

- ATE vs treatment - placebo comparison

### Outcomes 

- single outcome, indices, latent outcome vs observable outcome



## Three families of inquiries

<!-- we suggest replacing this section with an elaboration of "elements of inquiries" and fit these into them -->
...
The first estimand is a descriptive estimand: the average outcome for $Y$ when $D = 1$. Note that the declaration of the estimand does not make use of any counterfactual quantities.   
