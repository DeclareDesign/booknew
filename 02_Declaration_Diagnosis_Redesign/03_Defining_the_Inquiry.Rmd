...
In the example in Table \@(tab:MI3) we ask an attribution question of this form but on continuous data. We use the same reference model $M$ and ask about the share of units with positive values of $Y$ and $Z=1$ that would have had negative values of $Y$ were $Z=0$.
