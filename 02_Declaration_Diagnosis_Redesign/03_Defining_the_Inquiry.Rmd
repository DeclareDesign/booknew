...
Qualitative comparative analysis (QCA) with boolean variables ("crisp-set QCA"), for example, focuses on a similar set of inquiries that are expressed in set theoretic rather than probabilistic terms, i.e., the minimal set of conditions sufficient to produce $Y$. If $Y$ happens any time that causal factor $A$ is present or when $A$ is absent but $B$ is present, then $a^M$ is a set: $\{A, \not A \& B\}$.
