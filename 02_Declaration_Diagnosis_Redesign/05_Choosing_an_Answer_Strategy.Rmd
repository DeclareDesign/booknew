...
Set-theoretic approaches to formalize qualitative reasoning focus on deterministic concepts of causal necessity and sufficiency. Variants of qualitative comparative analysis (QCA), which typically seeks to understand the minimal set of combinations of factors sufficient to produce an outcome, have been implemented on computers, and are therefore straightforward to declare and diagnose. We provide an example in @bccmapsr. QCA has been the subject of numerous simulation studies: (ADD HERE).
