...
Many qualitative research agenda focus on causal attribution inquiries (see Section \@ref(causalattribution)), that seek to know whether a postulated cause was really necessary or sufficient to produce an outcome. As such, tools of logic that explore necessity and sufficiency through probabilistic and deterministic reasoning are central to many qualitative answer strategies. However, it is important to distinguish between answer strategies and inquiries. Just as there are quantitative strategies that target causal attribution inquiries [@yamamoto2012understanding], there are qualitative answer strategies that can be used to understand inquiries about causal effects.
