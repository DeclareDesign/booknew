...
Researchers select several characteristics of $Q$: who collects the measures; the mode of measurement; how often and when measures are taken; how many different observed measures of $Y^*$ are collected and how they are summarized into a single measure; and what information is provided to participants about how they are being measured (if any). 

WHO
- the researcher, the participant, or a third party (e.g., administrative data collected by government)

MODE
- what mode they use to collect it: human coding of observations by sight, hearing, touch, smell, and taste; the special human coding through asking other humans in surveys; recordings of waves of light (e.g., photos), sound (e.g., audio and seismic recordings), electromagnetic waves (e.g., EKGs and x-rays), and combinations (e.g., video); thermometers and barometers; medical and biometric devices (e.g., blood tests)
...
WHAT INFORMATION IS PROVIDED TO PARTICIPANTS ABOUT MEASUREMENT (IF ANY)
