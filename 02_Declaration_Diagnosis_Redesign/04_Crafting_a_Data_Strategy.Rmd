...
- measurement tools may have higher and lower validity and reliability. instruments can be calibrated and tested through multiple measurements. 
- fundamental problem of validation studies: we never know the truth, so can only compare different observations with different tools

These measures may be taken by the research participant themselves, by researchers, or by a third party (e.g., administrative data collected by government).
- problem of self-reports and sensitivity bias
- hawthorne effects
- demand effects
