...
1. **Outcome variables**: the variable whose level or responses we want to understand, generally referred to as $Y$, as in the figure below. Variously described as "dependent variables", "endogenous variables, "left hand side" variables, "Response variables." 
