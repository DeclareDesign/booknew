...
Payoffs across two decision dimensions are show in n Figure @\ref(fig:optimialdesign).
...
```{r optimialdesign, echo = FALSE, purl = FALSE, eval = TRUE, fig.cap= "Utility over two design parameters."}
