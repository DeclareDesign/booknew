...
## Uses of Covariates in Experiments

- Covariates are pre treamtent X(0) = X(1) = X.

- covariates can be used in data strategy
- covariates can be used in answer strategy
- design comparison
- errors to avoid (conditioning on post-treatment variables)
