...
We define a design of this form with just a single candidate for simplicity. The design lets us assess the risks and benefits of different answer strategies given the endogeneous choice of estimand.
...
We include  diagnosands that take account of the fact that some runs of the designs to not produce estimates for thenew estimand.
