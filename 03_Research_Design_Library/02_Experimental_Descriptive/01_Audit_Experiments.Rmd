...
For example @WHITE_NATHAN_FALLER_2015 seeks to assess the effects of an email from a Latino name (versus a White name) on *whether* and *how well* election officials respond to requests for information. 
