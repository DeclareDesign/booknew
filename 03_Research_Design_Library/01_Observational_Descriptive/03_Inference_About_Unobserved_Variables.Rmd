...
The purpose of this unwritten entry is to show how a latent variable (`Y_star`) can be measured with three procedures (`Y_1`, `Y_2`, `Y_3`), which are then averaged into an index.

We'll of course be "biased" for the true latent variable. Could a reasonable diagnosand here be the average correlation of the estimated index with the latent value?
