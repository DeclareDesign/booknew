...
The variance of the list experiment is given by this expression, where $\V(Y_i(0)$ is the variance of the control item count and $\cov(Y_i(0), D_i^*)$ is the covariance of the control item count with the densitive trait.
